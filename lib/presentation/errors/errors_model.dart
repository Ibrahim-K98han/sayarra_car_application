...
class Errors extends Equatable {
  ...
  final List<String> whatsappNumber;
  final List<String> currencyId;
  final List<String> modelId;
  final List<String> carType;
  final List<String> carDrive;
  final List<String> acCondition;
  ...
  Errors copyWith({
    ...
    List<String>? whatsappNumber,
    List<String>? currencyId,
    List<String>? modelId,
    List<String>? carType,
    List<String>? carDrive,
    ...
    return Errors(
      ...
      carDrive: carDrive ?? this.carDrive,
      acCondition: acCondition ?? this.acCondition,
      role: role ?? this.role,
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'car_type_id': carType,
      'car_drive_id': carDrive,
      'ac_condation': acCondition,
      'role': role,
    };
  }
  ...
  factory Errors.fromMap(Map<String, dynamic> map) {
    ...
    return Errors(
      ...
      image4: map['image4'] != null
          ...
          : [],
      teamImage: map['team_image'] != null
          ? List<String>.from(map['team_image'].map((x) => x))
          : [],
      ...
      minBookingDate: map['min_booking_date'] != null
          ...
          : [],
      bodyType: map['body_type_id'] != null
          ? List<String>.from(map['body_type_id'].map((x) => x))
          : [],
      engineSize: map['engine_size_id'] != null
          ? List<String>.from(map['engine_size_id'].map((x) => x))
          : [],
      drive: map['drive'] != null
          ? List<String>.from(map['drive'].map((x) => x))
          : [],
      interiorColor: map['interior_color_id'] != null
          ? List<String>.from(map['interior_color_id'].map((x) => x))
          : [],
      exteriorColor: map['exterior_color_id'] != null
          ? List<String>.from(map['exterior_color_id'].map((x) => x))
          : [],
      year: map['year'] != null
          ? List<String>.from(map['year'].map((x) => x))
          : [],
      mileage: map['mileage_id'] != null
          ? List<String>.from(map['mileage_id'].map((x) => x))
          : [],
      ...
      numberOfSeat: map['number_of_seat'] != null
          ...
          : [],
      fuelType: map['fuel_type_id'] != null
          ? List<String>.from(map['fuel_type_id'].map((x) => x))
          : [],
      transmission: map['transmission_id'] != null
          ? List<String>.from(map['transmission_id'].map((x) => x))
          : [],
      ...
      phoneNumber: map['phone_number'] != null
          ? List<String>.from(map['phone_number'].map((x) => x))
          : [],
      whatsappNumber: map['whatsapp_number'] != null
          ? List<String>.from(map['whatsapp_number'].map((x) => x))
          : [],
      currencyId: map['currency_id'] != null
          ? List<String>.from(map['currency_id'].map((x) => x))
          : [],

      modelId: map['car_model_id'] != null
          ? List<String>.from(map['car_model_id'].map((x) => x))
          : [],
      carType: map['car_type_id'] != null
          ? List<String>.from(map['car_type_id'].map((x) => x))
          : [],
      carDrive: map['car_drive_id'] != null
          ? List<String>.from(map['car_drive_id'].map((x) => x))
          : [],
      acCondition: map['ac_condation'] != null
          ? List<String>.from(map['ac_condation'].map((x) => x))
          : [],
      role: map['role'] != null
          ? List<String>.from(map['role'].map((x) => x))
          : [],
    );
  }
